...
#define P_HM_USE_FROM_BAG                TRUE        // If TRUE, HMs can be used in the overworld if the HM item is in the bag and any compatible Pokémon is in the party, without needing to teach the move.
