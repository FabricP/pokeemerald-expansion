...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNCUTS_SPATKWITH]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s Sp. Atk!"), //not in gen 5+, ability popup
    ...
    [STRINGID_WILDPKMNDROPITEM]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} dropped one {B_LAST_ITEM}!"),
